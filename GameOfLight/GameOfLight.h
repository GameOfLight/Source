...
#include <SPI.h> //only used by hardware, but not possible to ignore includes inside defines in Arduino
...
#define FONT_3x5 1
  ...
  //Simulator protocol stuff
  #define SCREEN_DATA 0x11
  #define SCREEN_CMD 0x12
  #define SCREEN_DATA_BURST 0x13
  #define REQUEST_KEYS 0x14

  #define NUM_PLAYERS 2 //increase for more players if simulatorsupport is added later
#else
  //Hardware specific communcation stuff
...
class GameOfLight {
 public:
  ...
  //Methods for comunicating with the actual screen / outside HW / simulator
  void update(); 
